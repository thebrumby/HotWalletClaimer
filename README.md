...
💡 TIP: This script allows you to manage multiple HereWallet accounts using just one Telegram account by initiating multiple individual sessions. For a straightforward setup, consider using **SCREEN** (see the quick start guide below). However, for the more confident user, [PM2](#pm2) is recommended.
